          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value){
                if( value == null || value.isEmpty) return 'Ingrese un nombre';
                 if( value.length < 3) return 'El nombre debe de ser de tres letras como minimo';
                 return null;
              },
            ),
            ...
            ConstrainedBox(
              ...
              child: ElevatedButton(
                ...
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all(const Color.fromARGB(255, 123, 141, 243)),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: FloatingActionButton(
                        backgroundColor: const Color.fromARGB(255, 122, 138, 231),
                        elevation: 0,
