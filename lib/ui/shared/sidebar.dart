...
class Sidebar extends StatelessWidget {
      ...
      child: ListView(
        ...
        children: [
          ...
          MenuItem(
            ...
            onPressed: () => navigateTo(Flurorouter.postsRoute),
            isActive: sideMenuProvider.currentPage == Flurorouter.postsRoute,
          ),
  ...
  BoxDecoration buildBoxDecoration() => BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(color: Color.fromARGB(255, 181, 215, 244), blurRadius: 10)
          ]);
}
